...
\begin{titlepage}
    ...
    \fbox{\begin{minipage}{0.8\textwidth}
        \centering
        \textbf{Anfrage:} KI Entwicklung Deutschland 2024
    \end{minipage}}
    ...
    {\large
    Erstellt am: 09.08.2025 20:11\\
    Workflow ID: b080d69e-e467-4904-a602-cd062abeda6b
    }
...
\textbf{News:}
\begin{itemize}
\item US hunter reportedly killed by buffalo during expedition in South Africa
\item Trump will Putin treffen: Deutschland und Europa müssen zahlen
\item Assault on Sudan’s Zamzam refugee camp may have killed more than 1,500 civilians
\end{itemize}
