#!/usr/bin/env python3
"""
Test script for session management dashboard functionality
"""
...
def test_dashboard_session_api():
    ...
    test_session = {
        ...
        'model': 'codellama:7b',
        'project_folder': '/tmp/test-session'
    }
...
def start_dashboard_for_test():
    ...
    os.chdir('/home/oliver/Projects/ollama-flow/ollama-flow-python')
    
    # Start dashboard
    proc = subprocess.Popen([
        'python3', 'dashboard/simple_dashboard.py', 
        '--host', 'localhost', 
        '--port', '5001'
...
if __name__ == "__main__":
    print("🚀 Starting Dashboard Session Management Test")
    print("=" * 60)
